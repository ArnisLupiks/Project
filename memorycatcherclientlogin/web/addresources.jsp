    ...
    <body>
        <div class="navbar navbar-inverse navbar-fixed-top">
            ...
            <div class = "login_table">
                    ...
                    <h1 class="col-sm-10 login_h1">Enter resources</h1>
                </div>
                    <form class="form-horizontal"action="addnewresources.jsp" method ="post" role="form">
                        <div class="form-group">
                          <div class=" col-sm-10">
                            <input type="text" class="form-control input-lg" name="res" placeholder="Enter amount of Resources" />
                          </div>
                        </div>
                        
                        <div class="form-group">
                          <div class=" col-sm-10">
                            <button type="submit" class="btn btn-primary btn-lg btn-block">Add Resources</button>
                          </div>
                        </div>
                    </form>
            </div>
