...
public class _MemoryCatcherStub extends org.omg.CORBA.portable.ObjectImpl implements MemoryCatcherApp.MemoryCatcher
{
  ...
  public int shareMemory (int memoryId, String ShareUserId)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("shareMemory", true);
                $out.write_long (memoryId);
                $out.write_string (ShareUserId);
                $in = _invoke ($out);
                int $result = $in.read_long ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                ...
                return shareMemory (memoryId, ShareUserId        );
            } finally {
                _releaseReply ($in);
            }
  } // shareMemory
  ...
  public int addMessage (String messageName, String messageContent, String receiver)
  {
            ...
            try {
                ...
                return addMessage (messageName, messageContent, receiver        );
            } finally {
                _releaseReply ($in);
            }
  } // addMessage
