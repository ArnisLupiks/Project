                ...
                implements MemoryCatcherApp.MemoryCatcher, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getAllMemories", new java.lang.Integer (3));
    _methods.put ("addResources", new java.lang.Integer (4));
    _methods.put ("viewResources", new java.lang.Integer (5));
    _methods.put ("shareResources", new java.lang.Integer (6));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 3:  // MemoryCatcherApp/MemoryCatcher/getAllMemories
       {
       ...
       case 4:  // MemoryCatcherApp/MemoryCatcher/addResources
       {
       ...
       case 5:  // MemoryCatcherApp/MemoryCatcher/viewResources
       {
         MemoryCatcherApp.Resources $result[] = null;
         $result = this.viewResources ();
         out = $rh.createReply();
         MemoryCatcherApp.AllResourcesHelper.write (out, $result);
         break;
       }

       case 6:  // MemoryCatcherApp/MemoryCatcher/shareResources
       {
         int resources = in.read_long ();
