...
/**
* MemoryCatcherApp/AllMessagesHelper.java .
...
abstract public class AllMessagesHelper
{
  private static String  _id = "IDL:MemoryCatcherApp/AllMessages:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = MemoryCatcherApp.MessageHelper.type ();
      __typeCode = org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (MemoryCatcherApp.AllMessagesHelper.id (), "AllMessages", __typeCode);
    }
    return __typeCode;
  }
  ...
  {
    MemoryCatcherApp.Message value[] = null;
    int _len0 = istream.read_long ();
    value = new MemoryCatcherApp.Message[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = MemoryCatcherApp.MessageHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, MemoryCatcherApp.Message[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      MemoryCatcherApp.MessageHelper.write (ostream, value[_i0]);
  }
