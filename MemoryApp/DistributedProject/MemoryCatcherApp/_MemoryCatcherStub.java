...
public class _MemoryCatcherStub extends org.omg.CORBA.portable.ObjectImpl implements MemoryCatcherApp.MemoryCatcher
{
  ...
  public boolean addMemory (String memoryName, String memoryDescription, String username)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return addMemory (memoryName, memoryDescription, username        );
            } finally {
                _releaseReply ($in);
            }
  } // addMemory
  ...
  public boolean removeMemory (String memoryName)
  {
            ...
            try {
                ...
                return removeMemory (memoryName        );
            } finally {
                _releaseReply ($in);
            }
  } // removeMemory
  ...
  public String getMemory (String memoryName, String memoryContext)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getMemory", true);
                $out.write_string (memoryName);
                $out.write_string (memoryContext);
                $in = _invoke ($out);
                ...
                return getMemory (memoryName, memoryContext        );
            } finally {
                _releaseReply ($in);
            }
  } // getMemory
